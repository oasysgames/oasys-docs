...
description: "Common FAQ section for troubleshooting validator node."
keywords:
  - docs
  - validator
  - commands
...
| `admin_addTrustedPeer`                              | **Adds the peer to a reserved trusted list which allows the node to always connect, 
                                                      |   even if the slots are full.**                                                                    |
...
| `debug_setHead`                                     | **Sets the current head of the local chain by block number.**                                      |       | `les.latestCheckpoint`                              | **Gets the index and hashes of the latest known checkpoint.**                                      |
