...
- Status updates posted into the channel so moderators know when items are pending, approved, or rejected.

### Installation

1. Server admins open the deployment link: `https://discord.com/oauth2/authorize?client_id=1428271120754278522&permissions=2048&integration_type=0&scope=applications.commands+bot`.
