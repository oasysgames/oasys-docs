...
Please refer to [Install Metamask](/docs/tech/wallet/1-4) document for basic installation instructions.
...
![Setting testnet set option1](/img/docs/tech/smart-contract/add-testnet-1.png)
...
![Setting testnet set option2](/img/docs/tech/smart-contract/add-testnet-2.png)
...
![Setting testnet set option3](/img/docs/tech/smart-contract/add-testnet-3.png)
...
![Smart Contract Wizard](/img/docs/tech/smart-contract/contract-wizard.png)
...
![Deploy Smart Contract](/img/docs/tech/smart-contract/deploy-contract-1.png)
...
![Deploy Smart Contract](/img/docs/tech/smart-contract/deploy-contract-2.png)
...
![Deploy Smart Contract](/img/docs/tech/smart-contract/deploy-contract-3.png)
...
## Mint ERC-20 token
![Mint ERC-20 Token](/img/docs/tech/smart-contract/mint-erc20-token-1.png)
...
![Mint ERC-20 Token](/img/docs/tech/smart-contract/mint-erc20-token-2.png)
...
![Import ERC-20 Token](/img/docs/tech/smart-contract/import-token-1.png)
...
![Import ERC-20 Token](/img/docs/tech/smart-contract/import-token-2.png)
...
![Add Oasys Sand Verse network on metamask](/img/docs/tech/smart-contract/add-network-1.png)
...
## Create a mintable ERC-20 token smart contract using the Openzepplin contracts wizard
Please refer to [this](/docs/tech/build/erc-token/1-2#create-a-mintable-erc-20-token-smart-contract-using-the-openzepplin-contracts-wizard) section because the Openzepplin contracts wizard uses the same method of creating a Smart Contract.

## Deploy the smart contract using Remix IDE
![Deploy Smart Contract - Sand Verse](/img/docs/tech/smart-contract/deploy-contract-sandverse-1.png)
Create the MyToken.sol file in Remix IDE, as shown in [this](/docs/tech/build/erc-token/1-2#deploy-the-smart-contract-using-remix-ide) section.

![Deploy Smart Contract - Sand Verse](/img/docs/tech/smart-contract/deploy-contract-sandverse-2.png)
...
![Deploy Smart Contract - Sand Verse](/img/docs/tech/smart-contract/deploy-contract-sandverse-3.png)
...
## Mint ERC-20 token
![Mint ERC-20 Token](/img/docs/tech/smart-contract/mint-erc20-token-sandverse-1.png)
- If Deploy is successful, you can see that Deployed Contract has been added.

1. You should click on the `mint` function created in MyToken.sol to set the address to send the token and the amount of tokens to send.
2. When ready, click the `transact` button and approve the transaction for token transfer.

* Please refer to [this](/docs/tech/build/erc-token/1-2#metamask-gas-fee-settings) section for gas fee modification.

![Mint ERC-20 Token](/img/docs/tech/smart-contract/mint-erc20-token-sandverse-2.png)
...
![Import ERC-20 Token](/img/docs/tech/smart-contract/import-token-sandverse-1.png)
- Visit Oasys Sandverse to view information about the minted token. You can copy the token's smart contract address and import it into the meta mask according to how it was written in [this](/docs/tech/smart-contract/build/erc-token/1-2#import-token-to-metamask) section.